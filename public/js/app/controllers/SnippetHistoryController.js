define([ 'App', 'backbone', 'marionette' ], function(App, Backbone,
  ...
  var commentItem = Marionette.ItemView.extend({
    tagName : 'li',
    className : 'list-group-item', template : _.template('<p>\
    ...
    modelEvents : {"change:active" : "ChangeColor"},
  ...
  var historyItem = Marionette.CompositeView.extend({
    tagName : 'li',
    className : 'list-group-item', template : _.template('<p class="title">\
    ...
    modelEvents : {'change:active' : 'changeActive'},
    collectionEvents : {
      'add' : 'changeCount',
      'remove' : 'changeCount',
    ...
    onShowComments : function() { this.ui.comments.toggle(); },
  ...
  var historyListView = Marionette.CompositeView.extend({
    ...
    'collectionEvents' : {'add' : 'onAdd', 'remove' : 'onRemove'},
    events : {"click @ui.save" : "onSave"},
