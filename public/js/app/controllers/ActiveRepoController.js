define(
    [ 'App', 'backbone', 'marionette', 'views/PageWrapperView' ],
    function(App, Backbone, Marionette, PageWrapperView) {
      ...
      var repoItemView = Marionette.CompositeView.extend({
        ...
        template : _.template('\
          ...
          <strong itemprop="name"><a href="/github.com/<%= full_name %>" data-pjax="#js-repo-pjax-container"><%= getRepo() %><%= getBranch() %></a></strong>\
          '),
